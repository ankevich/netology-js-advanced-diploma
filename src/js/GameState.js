...
export default class GameState {
  ...
  reassignPositions() {
    const allowedPlayerStartPositions = [0, 1, 8, 9, 16, 17, 24, 25, 32, 33, 40, 41, 48, 49, 56, 57];
    const allowedComputerPositions = [6, 7, 14, 15, 22, 23, 30, 31, 38, 39, 46, 47, 54, 55];
    this.positions = [];
  ...
  restoreFrom({
    currentTheme, currentLevel, currentPlayer, positions,
  }) {
    this.playerTeam = [];
    this.computerTeam = [];
  ...
  characterFromData = ({
    type, level, health, attack, defence, range,
  }) => {
